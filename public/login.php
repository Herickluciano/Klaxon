...
if (isset($_POST['submit'])) {
    if (!empty($_POST['pseudo']) && !empty($_POST['password']) && !empty($_POST['mail'])) {
        ...
        if ($checkUser->rowCount() > 0) {
            header('Location: /Klaxon_MVC_PHP/app/View/home/index.php');
             exit();
        } else {
            ...
            $message = "❌ Ce pseudo ou e-mail n'existe pas.";
        }
    } else {
...
<?php endif; ?>
    <form action="" method="post" novalidate>
     ...
     <p class="redirect">Vous etes visiteur ? <a href="/Klaxon_MVC_PHP/app/View/home/visiteur.php">Voir les places</a></p>
    <p class="redirect">Vous n'etes pas inscrire ? <a href="/Klaxon_MVC_PHP/public/inscription.php">Inscription</a></p>
  </div>
